...
namespace SMBD_LadderGenerator
{
    ...
    /// </summary>
    internal static class LadderCalcFx
    {
        ...
        public static int StepQuantity(int baseLength, int maxSpacing)
        {
            // Returns number of steps
            return Convert.ToInt16(Math.Ceiling((double)baseLength / (double)maxSpacing));
        }
        ...
        public static int StepSpacing(int baseLength, int stepQuantity)
        {
